 ...
 *
 */
public class Auto_TestWorking_Z_RightstartCommandGroup extends CommandGroup {

    public Auto_TestWorking_Z_RightstartCommandGroup() {
    	...
    	addSequential(new A_RotateTo270());
    	...
    	addSequential(new A_RotateTo225());
